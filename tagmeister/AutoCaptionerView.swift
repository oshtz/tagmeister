...
struct AutoCaptionerView: View {
    ...
    private func processCaption(_ caption: String) -> String {
        ...
        let prefixesToRemove = ["The image features", "The image depicts", "The image shows", "This image depicts", "This image shows", "This image features", "The image appears to depict ", "This image appears to depict "]
